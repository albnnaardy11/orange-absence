...
Solusi cepat untuk masalah operasional yang sering ditemui oleh Sekretaris dan Anggota.

## Masalah Umum (Anggota)
...
- **Solusi**: Pastikan perintah `php artisan schedule:run` terdaftar di *Cron Jobs* server.

## FAQ (Pertanyaan Sering Diajukan)

**Apakah data absen bisa diubah manual?**
Ya. Sekretaris bisa mengubah status lewat Admin Panel (menu Attendances) jika ada member yang lupa scan tapi terbukti hadir.
