  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Orange Absence System. Built with Docusaurus.`,
      },
      prism: {
